...
export const empleadoApi = {
  ...
  listarPaginado: (page: number, pageSize = 15, incluirInactivos = false) =>
    apiGet<PaginatedResult<Empleado>>(`/empleados?page=${page}&pageSize=${pageSize}${incluirInactivos ? '&incluirInactivos=true' : ''}`),
